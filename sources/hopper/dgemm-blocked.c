...
void pack_B_matrix(const double *restrict bPacked, const int N, const int K,
...
void pack_A_matrix(const double *restrict aPacked, const int K, const int M,
...
void prepare_A_matrix(const double *restrict aPacked, const int K, const int M,
